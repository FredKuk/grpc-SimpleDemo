...
@javax.annotation.Generated(
    ...
    comments = "Source: hellowolrd.proto")
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.hippo.HelloRequest,
      com.hippo.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.hippo.HelloRequest.class,
      responseType = com.hippo.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hippo.HelloRequest,
      com.hippo.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.hippo.HelloRequest, com.hippo.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.hippo.HelloRequest, com.hippo.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hippo.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hippo.HelloReply.getDefaultInstance()))
  ...
  public static abstract class SimpleImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.hippo.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hippo.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.hippo.HelloRequest,
                com.hippo.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
    ...
    /**
     */
    public com.hippo.HelloReply sayHello(com.hippo.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hippo.HelloReply> sayHello(
        com.hippo.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.hippo.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hippo.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hippo.HelloWorldProto.getDescriptor();
    }
